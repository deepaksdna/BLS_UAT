    ...
    <?= $this->Form->create($category, ['type'=>'file', 'class'=>'form-horizontal form-label-left']) ?>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('parent_id', ['options' => $AllCategories, 'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					 <div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						...
						echo $this->Form->input('category_detail.image', ['type'=>'file', 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']);
