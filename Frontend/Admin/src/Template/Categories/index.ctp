        ...
        <tbody>
			...
			<!--<td class="a-center ">
                ...
                <td><?= h($category->modified) ?></td>
						...
						<td class="last">  <?= $this->Html->link(__(''), ['action' => 'edit', $category->id], ['class'=>'fa fa-pencil']) ?></td>
						<td class="last"><?= $this->Form->postLink(__(''), ['action' => 'delete', $category->id], ['class'=>'fa fa-trash','confirm' => __('Are you sure you want to delete # {0}?', $category->id)]) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
