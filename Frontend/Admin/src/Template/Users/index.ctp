                    ...
                    <tbody>
					 <?php foreach ($users as $user): ?>
                      <tr class="even pointer">
                        ...
                        <td class=" "><?= h($user->email) ?><i class="success"></i></td>
                        <td class=" ">
						...
						<td class="last"><?= $this->Html->link(__(''), ['action' => 'view', $user->id], ['class'=>'fa fa-desktop']) ?></td>
						<td class="last"><?= $this->Form->postLink(__(''), ['action' => 'delete', $user->id], ['class'=>'fa fa-trash', 'confirm' => __('Are you sure you want to delete # {0}?', $user->id)]) ?></td>
                      </tr>
					  <?php endforeach; ?>
                    </tbody>
                  </table>
