...
<div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><?= __('Edit Product :: '.$product->item_code) ?>  </h2>
	...
	<!-- Smart Wizard -->
		...
		<!--Brand-->
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('products_category.category_id', ['options' => $AllCategories,'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>						
                      </div>
                    </div>
	...
	<div class="productsImages form large-9 medium-8 columns content">
			  ...
			  <div class="clearfix"></div>				
                ...
                <div class="col-xs-12 text-right action">
                   <!-- <?= $this->Html->link('', ['controller' => 'ProductsMarketingImages','action' => 'edit', $productsmarketingImage->id], ['class'=>'fa fa-pencil']) ?>-->
                    <?= $this->Html->link('', ['controller' => 'ProductsMarketingImages','action' => 'deleteimage', $productsmarketingImage->id], ['class'=>'fa fa-trash','confirm' => __('Are you sure you want to delete marketing image?', $productsmarketingImage->id)]) ?>
                </div>
				  <div class="clearfix"></div>
				</div>
        </div>
		...
		<div class="form-group gray form-horizontal">
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-12 mtop10">
						<?php echo $this->Form->input('image', ['label'=>'Images','type'=>'file','required'=> true, 'label' => false, 'class'=>' col-xs-12']); ?>
...
<!-- Color Images  -->	
    ...
    <?php foreach ($product->products_images as $productsImage): ?>
			 ...
			 <div class="col-sm-2"> 
              ...
              <div class="thumb-product">
				<small><?= $productsImage->product_code; ?></small>			  
			  ...
			  <div class="clearfix"></div>				
                ...
                <div class="col-xs-12 text-right action">
                   ...
                   <!-- <?= $this->Html->link('', ['controller' => 'ProductsImages','action' => 'edit', $productsImage->id], ['class'=>'fa fa-pencil']) ?>-->
                    <?= $this->Html->link('', ['controller' => 'ProductsImages','action' => 'deleteimage', $productsImage->id], ['class'=>'fa fa-trash','confirm' => __('Are you sure you want to delete colored Image?', $productsImage->id)]) ?>
...
<?= $this->Form->create("promotion", ['url'=>['controller'=>'Promotions', 'action'=>'addPromotion'], ['class'=>'form-inline']]) ?>
    <table  class="table table-striped responsive-utilities jambo_table bulk_action" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
				...
				<?php if($promotion->discount_type=='P'){
					$Type='Purchase with Purchase';
				}elseif($promotion->discount_type=='D'){
					$Type='Direct Discount';	
				}elseif($promotion->discount_type=='F'){
					$Type='Free of Cost';	
				}elseif($promotion->discount_type=='B'){
					$Type='Bulk Discount';	
				} ?>
	...
	<tr>
			...
			<td><div class="form-group"> <?= $this->Form->input('formal_message_display',['label' => false, 'class'=>'form-control']);?></div></td>
			...
			<?= $this->Form->input('start_date',['label' => false, 'class'=>'form-control date-picker', 'readonly']);?>
			</div></td>
			
			<td><div class="form-group"> <?= $this->Form->input('end_date',['label' => false, 'class'=>'form-control date-picker', 'readonly']);?></div></td>
			...
			<td><div class="form-group"><?php echo $this->Form->input('discount_type', ['options'=>['D'=>'Direct Discount','B'=>'Bulk Discount', 'P'=>'Purchase with Purchase', 'F'=>'Free of Cost'],'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?></div></td>
