...
//debug($userDetail);
   ...
   <!-- <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
					   <?php echo $this->Form->input('blockno', ['label' => false,'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
					   <?php echo $this->Form->input('unitno', ['label' => false,'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
					   <?php echo $this->Form->input('company', ['label' => false,'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
					   <?php echo $this->Form->input('position', ['label' => false,'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
