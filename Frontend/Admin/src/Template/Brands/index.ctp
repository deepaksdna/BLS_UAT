              ...
              <div class="x_panel">
               ...
               <!-- <th><?= $this->Paginator->sort('id') ?></th>-->
                ...
                <th class="column-title"><?= $this->Paginator->sort('image') ?></th>
				 <th class="column-title"><?= $this->Paginator->sort('Template') ?></th>
        ...
        <tbody>
            <?php foreach ($brands as $brand): ?>
             <tr class="even pointer">
				...
				<td class="last"><?= $this->Html->link(__(''), ['action' => 'view', $brand->id], ['class'=>'fa fa-desktop']) ?></td>
						<td class="last">  <?= $this->Html->link(__(''), ['action' => 'edit', $brand->id], ['class'=>'fa fa-pencil']) ?></td>
						<td class="last"> <?= $this->Form->postLink(__(''), ['action' => 'delete', $brand->id], ['class'=>'fa fa-trash', 'confirm' => __('Are you sure you want to delete # {0}?', $brand->id)]) ?></td>
