...
<nav class="large-3 medium-4 columns mbot15" id="actions-sidebar">
    <ul class="nav nav-pills links-admin">
       <!-- <li class="heading"><?= __('Actions') ?></li>-->
        <li><?= $this->Html->link(__('Edit Configuration'), ['action' => 'edit']) ?> </li>
       <!-- <li><?= $this->Form->postLink(__('Delete Configuration'), ['action' => 'delete', $configration->id], ['confirm' => __('Are you sure you want to delete # {0}?', $configration->id)]) ?> </li>
