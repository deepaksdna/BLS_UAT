        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($group->modified) ?></td>
						<td class="last">  <?= $this->Html->link(__(''), ['action' => 'edit', $group->id],['class'=>'fa fa-pencil']) ?></td>
						<td class="last"><?= $this->Form->postLink(__(''), ['action' => 'delete', $group->id], ['class'=>'fa fa-trash', 'confirm' => __('Are you sure you want to delete # {0}?', $group->id)]) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
