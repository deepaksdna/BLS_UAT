					 ...
					 ?>
                      ...
                      <tr class="even pointer">
                       <!-- <td class="a-center ">
						...
						<td class="last"><?= $this->Html->link(__(''), ['action' => 'view', $admin->id],['class'=>'fa fa-desktop']) ?></td>
						<td class="last">  <?= $this->Html->link(__(''), ['action' => 'edit', $admin->id],['class'=>'fa fa-pencil']) ?></td>
						<td class="last"><?= $this->Form->postLink(__(''), ['action' => 'delete', $admin->id], ['class'=>'fa fa-trash', 'confirm' => __('Are you sure you want to delete # {0}?', $admin->id)]) ?></td>
                      </tr>
					  <?php endforeach; ?>
                    </tbody>
                  </table>
