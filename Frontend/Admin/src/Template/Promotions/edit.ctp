<nav class="large-3 medium-4 columns mbot15" id="actions-sidebar">
    <ul class="nav nav-pills links-admin">
		...
		<li><?= $this->Html->link(__('New Promotions'), ['controller' => 'Promotions', 'action' => 'add']) ?></li>
...
<div class="row">
	...
	<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Text Message<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('formal_message_display', ['required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>					
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('start_date', ['required'=> true, 'label' => false, 'class'=>'date-picker form-control col-md-7 col-xs-12', 'readonly']); ?>
                      </div>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('end_date', ['required'=> true, 'label' => false, 'class'=>'date-picker form-control col-md-7 col-xs-12', 'readonly']);?>
                      </div>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('associated_product', ['options'=>['True','False'],'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('discount_parent_in', ['options'=>['$'=>'$','%'=>'%'],'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('discount_child_in', ['options'=>['$'=>'$','%'=>'%'],'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo $this->Form->input('discount_type', ['options'=>['D'=>'Direct Discount','B'=>'Bulk Discount', 'P'=>'Purchase with Purchase', 'F'=>'Free of Cost'],'required'=> true, 'label' => false, 'class'=>'form-control col-md-7 col-xs-12']); ?>
                      </div>
                    </div>
