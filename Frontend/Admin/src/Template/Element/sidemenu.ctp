<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-users"></i> Customer Management <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li>
					<?= $this->Html->link(__('Customer list'), ['controller'=>'Users', 'action' => 'index']) ?>
                    </li>
                   <!-- <li>
                ...
                <li><a><i class="fa fa-shopping-bag"></i> Product Management <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
					 ...
					 <li><?= $this->Html->link(__('Bulk Add Products'), ['controller'=>'Products', 'action' => 'bulkadd']) ?>
                    </li>
					<li><?= $this->Html->link(__('Logs'), ['controller'=>'Logs', 'action' => 'index']) ?>
                    </li>
                  </ul>
                </li>
                  ...
                  <ul class="nav child_menu" style="display: none">
					 ...
					 <li><?= $this->Html->link(__('Bulk Add Promo'), ['controller'=>'Promotions', 'action' => 'bulkaddpromo']) ?>
                    </li>
                  </ul>
                </li>
            ...
            <div class="menu_section">
              <h3>My Store</h3>
              <ul class="nav side-menu">
                <li><a><i class="fa fa-bug"></i> Configurations <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li>
