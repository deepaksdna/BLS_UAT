...
/**
 * OrdersBillingsFixture
 *
 */
class OrdersBillingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fax_no' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'telephone' => 1,
            'fax_no' => 1,
            'created' => '2016-09-16 12:33:41',
            'modified' => '2016-09-16 12:33:41'
        ],
    ];
}
