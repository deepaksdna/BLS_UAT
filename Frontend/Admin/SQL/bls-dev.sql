...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2016 at 07:56 AM
...
(2, 10, '2016-09-06 00:00:00', '2016-09-22 17:38:44');
...
INSERT INTO `cart_products` (`id`, `cart_id`, `prod_id`, `prod_quantity`, `promotion_code`, `final_item_price`, `final_price`, `created`, `modified`) VALUES
(1, 1, 1, 10, 1, '', '', '2016-09-21 00:00:00', '2016-09-26 01:14:22'),
(2, 1, 2, 3, 0, '', '', '2016-09-20 00:00:00', '2016-09-26 01:14:22');
...
(1, 'Boon Lay Stationary', 'favicon.jpg', 'webroot\\img\\files\\Configrations\\logo\\', 'BLS | Ecommerce', 'https://facebook.com/bls', 'https://twitter.com/bls', 'SGD', '7', '500', '60', 'admin@bls.com', '100', 'You got this promotion.', 'value plus', 'solo plus', 'pwp', '2016-07-18 06:44:20', '2016-09-24 10:00:44');
...
(1, 'TA10DE1-1', 'First Product', 'First Product Description', '2016-09-22 07:41:52', '2016-09-22 13:33:52', 'N'),
...
(1, 1, '0', '0', '0', '2016-09-22 07:41:52', '2016-09-22 07:41:52'),
...
(1, 'CASH400', 'THIS is my promo', 1, '1', 1, '23-09-2016', '30-09-2016', '1', '2', '67', 56, '$', '$', 'P', '2016-09-23 05:47:47', '2016-09-27 11:54:47'),
...
INSERT INTO `user_addresses` (`id`, `user_id`, `street_address`, `city`, `state`, `country`, `postalcode`, `telephone`, `fax_no`, `block_no`, `unit_no`, `created`, `modified`) VALUES
...
ALTER TABLE `user_details` CHANGE `company` `company` VARCHAR(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL;
