...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2016 at 01:39 PM
...
(5, 9, '2016-10-07 12:29:37', '2016-10-07 12:29:37'),
(6, 20, '2016-10-13 11:07:45', '2016-10-13 11:07:45');
...
INSERT INTO `cart_products` (`id`, `cart_id`, `prod_id`, `prod_quantity`, `created`, `modified`) VALUES
(11, 5, 1, 3, '2016-10-07 12:29:37', '2016-10-13 04:21:33'),
(15, 5, 6, 14, '2016-10-12 12:47:26', '2016-10-13 10:07:30'),
(16, 5, 5, 5, '2016-10-12 12:51:17', '2016-10-13 11:09:04'),
(17, 6, 5, 1, '2016-10-13 11:07:45', '2016-10-13 11:07:45');
...
CREATE TABLE `orders` (
  ...
  `refrenceCode` varchar(255) NOT NULL,
  `invoiceCode` varchar(255) NOT NULL,
  `otherCode` varchar(255) NOT NULL,
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'CASH400', 'THIS is my promo', 4, '1', 3, '23-09-2016', '21-10-2016', '0', '2', '88', 5, '%', '%', 'P', '2016-09-23 05:47:47', '2016-10-12 11:27:10'),
(2, 'CASH200', 'This is Second Promo', 1, '11', 1, '29-09-2016', '28-10-2016', '0', '2', '30', 5, '$', '$', 'D', '2016-09-23 05:50:30', '2016-10-12 11:41:15'),
(3, 'CSHA2000', 'fggdf g fgfg ', 6, '1', 10, '29-09-2016', '04-11-2016', '1', '1', '67', 4, '%', '$', 'D', '2016-09-29 12:06:07', '2016-10-12 11:42:11');
...
(20, 'kalpna@sdnainfotech.com', '1', 'e10adc3949ba59abbe56e057f20f883e', '2016-10-13 11:06:14', '2016-10-13 11:06:14');
...
(7, 10, '', 'fxfgg', 'dfggdg', 'dfgdfgdfg', 'gdfgdgdgf', 'gdfgdfgfg', 0, 543353453, '', '', '2016-10-13 05:54:43', '2016-10-13 05:54:43');
...
INSERT INTO `user_billings` (`id`, `user_id`, `sender_name`, `city`, `state`, `fax_no`, `email_address`, `block_no`, `unit_no`, `street`, `company`, `position`, `postalcode`, `telephone`, `country`, `created`, `modified`) VALUES
(1, 9, 'Pradeep', '', '', '', 'pradeep.ddd@gmail.com', '#123', '55', 'Town', '', '', '160110', 2147483647, 'india', '2016-09-20 00:00:00', '2016-09-26 12:28:35'),
(3, 20, 'Kalpna Thakur', NULL, NULL, NULL, 'kalpna@sdnainfotech.com', '1256566', '345656', 'test', '', '', '123456566', 755555, 'Singapore', '2016-10-13 11:06:14', '2016-10-13 11:06:14');
...
(15, 10, 'Himani', 'Arora', 'Chrysanthemum.jpg', 'webroot\\img\\files\\UserDetails\\image\\', '08-07-1980', 'Female', '9123456789', '45 gh , Vihar colony', '123456', 'SDNA', 'Project manager', '2016-09-06 05:07:47', '2016-10-13 05:55:37'),
...
(25, 20, 'Kalpna', 'Thakur', '', '', '', '', '', '1256566', '345656', NULL, 'software', '2016-10-13 11:06:14', '2016-10-13 11:06:14');
